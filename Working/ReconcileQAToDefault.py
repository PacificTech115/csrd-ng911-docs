"""
Standalone ArcGIS Notebook script to reconcile/post QA into DEFAULT.
Run this as step 3 after QA checks complete.
"""
...
def finalize_run(summary: dict, run_id: str, status: str) -> str:
    ...
    out_path = os.path.join(NB_RUN_DIR, f"reconcile_qa_to_default_run_{run_id}.json")
...
def main():
    ...
    print("\n=== Reconcile/Post: QA -> DEFAULT ===")
    res_recon = run_reconcile_stage(tbx_recon, "QA_TO_DEFAULT", gis)
    summary["stages"]["QA_TO_DEFAULT"] = res_recon
